...
public class View extends Empfaenger {
    ...
    public void einloggen(){
        ...
        JFrame fenster = new JFrame("Bitte registrieren Sie sich");
        fenster.setSize(220, 400);
        fenster.setLocationRelativeTo(null);
        ...
        JLabel id = new JLabel("IHRE ID: ");
        contentPane.add(id);

        JLabel pw = new JLabel("IHR PASSWORT: ");
        contentPane.add(pw);
        ...
        reg.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e) {
                    registriert = true;
                    id.setText("IHRE ID: "+ besucherID);
                    pw.setText("IHR PASSWORT: beispielPasswort");
